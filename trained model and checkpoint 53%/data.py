...
def get_data_loaders(
    ...
    data_transforms = {
        "train": transforms.Compose(
            ...
            [transforms.RandomHorizontalFlip(),
                                      ...
                                      transforms.ColorJitter(brightness = 0.6, contrast=0.7),
                                      transforms.ToTensor(),
    ...
    data_loaders["test"] = torch.utils.data.DataLoader(
        # YOUR CODE HERE (remember to add shuffle=False as well) - shuffle=False is the default setting, but will proforma be set
        test_data,
        batch_size=batch_size,
        shuffle=False,
        num_workers=0
